...
CREATE TABLE IF NOT EXISTS stations (
    ...
    station_key VARCHAR(255) UNIQUE NOT NULL,
...
INSERT INTO stations (id, name, location, station_key, status, last_seen) 
VALUES ('STATION_0001', 'Station de Test', 'Salle A101', 'demo_station_key_001', 'active', NOW())
