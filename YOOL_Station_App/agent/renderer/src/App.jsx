...
const STATION_KEY = import.meta.env.VITE_STATION_KEY || "";
...
function App() {
  ...
  const handleCardScan = async (cardId) => {
    ...
    try {
      ...
      const verify = await verifyCard(cardId, STATION_ID, STATION_KEY);
      ...
      const sessLog = await startSession(actualCardId, STATION_ID, studentId, studentName, STATION_KEY);
      ...
      if (code === 401) {
        applyStatus("error", t.station_key_error);
      } else if (code === 403) {
