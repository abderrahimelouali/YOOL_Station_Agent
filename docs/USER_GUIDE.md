...
- Elle envoie sa clé (agent key) et son ID au serveur.
...
- [**Spécifications des APIs**](API_REFERENCE.md)
- [**Détails du Schéma BDD**](DATABASE_SCHEMA.md)
- [**Guide SSO & JWT Deep-Dive**](SSO_TECHNICAL_V3.md)
- [**Guide de Maintenance Équipe**](MAINTENANCE_GUIDE.md)

---

## 6. Intégration SSO JWT
